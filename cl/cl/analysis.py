...
def plot_latent_gradient(embedding, labels, jet_feat, classes, jet_feat_name, title, rand_state, runs):
    """
...
def main():
    ...
    #Plot
    plot_latent_gradient(embedding, labels, jet_feat, classes, jet_feat_name, title=f'Latent embedding colored by {jet_feat_name}', rand_state=rand_number, runs=runs)
